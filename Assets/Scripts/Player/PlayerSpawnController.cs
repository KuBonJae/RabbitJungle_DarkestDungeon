...
public class PlayerSpawnController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // DD
        go = Instantiate(Player1, new Vector3(0, 0, 0), Player1.transform.rotation);
        go.GetComponent<PlayerController>().map = map;
        go.GetComponent<PlayerController>().keyGuide = keyGuide;
